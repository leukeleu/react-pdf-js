...
var _text_layer_builder = require('pdfjs-dist/lib/web/text_layer_builder');
...
var Pdf = function (_React$Component) {
  ...
  function Pdf(props) {
    ...
    if (!(typeof _this.onResize === 'function')) {
      throw new TypeError('Value of "this.onResize" violates contract.\n\nExpected:\n() => any\n\nGot:\n' + _inspect(_this.onResize));
    }

    _this.renderPdf = _this.renderPdf.bind(_this);

    if (!(typeof _this.renderPdf === 'function')) {
      throw new TypeError('Value of "this.renderPdf" violates contract.\n\nExpected:\n() => any\n\nGot:\n' + _inspect(_this.renderPdf));
    }
  ...
  (0, _createClass3.default)(Pdf, [{
    ...
    value: function getDocument(val) {
      ...
      this.documentPromise.promise.then(this.onDocumentComplete).catch(this.onDocumentError.bind(this));
    ...
    value: function loadPDFDocument(props) {
      ...
      if (props.file) {
        ...
        reader.onloadend = function () {
          return _this3.loadByteArray(new Uint8Array(reader.result));
        };
    ...
    value: function renderPdf() {
      ...
      if (page) {
        ...
        var isPromise = typeof this.renderTask !== 'undefined' && this.renderTask.hasOwnProperty('then') && typeof this.renderTask.then == 'function';
        if (isPromise) {
        ...
        this.renderTask = page.render(renderContext).then(function () {
          return page.getTextContent();
        }).then(function (textContent) {
          _this4.textLayerDiv.innerHTML = '';
          var textLayer = new _text_layer_builder.TextLayerBuilder({
            textLayerDiv: _this4.textLayerDiv,
