...
var Pdf = function (_React$Component) {
  ...
  function Pdf() {
    ...
    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, (_ref = Pdf.__proto__ || (0, _getPrototypeOf2.default)(Pdf)).call.apply(_ref, [this].concat(args))), _this), _this.state = {}, _this.onGetPdfRaw = function (pdfRaw) {
      ...
      _this.documentPromise.promise.then(_this.onDocumentComplete).catch(_this.onDocumentError.bind(_this));
      ...
      if (page) {
        ...
        var unAdjustedViewport = page.getViewport(scale, rotate);
        ...
        page.render({ canvasContext: canvasContext, viewport: viewport }).then(function () {
          ...
          _this.textLayerDiv.innerHTML = '';
          var textLayer = new _text_layer_builder.TextLayerBuilder({
            textLayerDiv: _this.textLayerDiv,
  ...
  (0, _createClass3.default)(Pdf, [{
    ...
    value: function render() {
      ...
      return page ? _react2.default.createElement(
        ...
        _react2.default.createElement('div', { ref: function ref(parentDiv) {
            _this2.canvasParent = parentDiv;
          } }),
        _react2.default.createElement('div', {
          className: 'textLayer',
          ref: function ref(textLayerDiv) {
            _this2.textLayerDiv = textLayerDiv;
          }
        })
